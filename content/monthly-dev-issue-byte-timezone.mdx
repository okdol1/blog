...
![글로벌 타임존 정상 화면](/posts/monthly-dev-issue-byte-timezone/3.png)

일부 국가에서 타임존이 undefined로 노출되는 경우:

![글로벌 타임존 undefined 노출 화면](/posts/monthly-dev-issue-byte-timezone/4.png)
...
2. 해당 국가 타임존을 노출되는지 기간 확인
   ![글로벌 타임존 개선](/posts/monthly-dev-issue-byte-timezone/5.png)
